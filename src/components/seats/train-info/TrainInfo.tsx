    ...
    <div className={styles.train__info}>
      ...
      <div className={`${styles.train__info__item} ${styles.directions__item}`}>
        <TicketLocation
          ...
          station={formatCityName(train.from.railway_station_name) + " вокзал"}
          containerClassName={styles.ticket_location}
          cityClassName={styles.city}
          stationClassName={styles.station}>
          <time className={styles.time}>{formatTime(train.from.datetime)}</time>
        </TicketLocation>
        {direction === "departure" && (
        ...
        <TicketLocation
          ...
          station={formatCityName(train.to.railway_station_name) + " вокзал"}
          containerClassName={styles.ticket_location}
          cityClassName={styles.city}
          stationClassName={styles.station}>
          <time className={styles.time}>{formatTime(train.to.datetime)}</time>
        </TicketLocation>
      </div>
